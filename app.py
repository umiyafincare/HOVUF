...
from reportlab.platypus iimport os
import urllib.parse
from datetime import datetime, time
import io
import sqlite3
    ...
    with st.form("pin_form"):
        ...
        if st.form_submit_button("💾 Update PIN"):
            if old_p == SQLManager.get_pin():
                ...
                st.error("Incorrect Current PIN!")mport SimpleDocTemplate, Paragraph, Spacer, Table, TableStyle, HRFlowable, Image as PDFImage
from reportlab.lib.styles import getSampleStyleSheet, ParagraphStyle
